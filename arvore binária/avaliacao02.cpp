...
void inserir_pretoEvermelho(No **root, No *Node)
{
    if (Node == NULL)
        return;
...
void balancear(No **root, No *node)
{
    ...
    if ((node->cor) == vermelho)
    {
        inserir_pretoEvermelho(root, node);
    }
}
        ...
        if (irmao_node == NULL || irmao_node->cor == preto)
        {
            ...
            if (irmao_node->esq != NULL)
            {
                if (irmao_node->esq->cor == vermelho)
                {
                    ...
                    {
                        irmao_node->pai->cor = vermelho;
                        irmao_node->cor = vermelho;
                        rot_dupla_esq(root, pai);
                    }
                    else
                    {
            ...
            if (irmao_node->dir != NULL)
            {
                if (irmao_node->dir->cor == vermelho)
                {
                    irmao_node->dir->cor = preto;
                    if (posicao_filho(irmao_node->pai, irmao_node) == 0)
                    {
                        irmao_node->pai->cor = vermelho;
                        irmao_node->cor = vermelho;
                        rot_dupla_dir(root, pai);
                    }
                    else
                    {
